"""This script is used to generate openrye/src/sources/generated/python_downloads.inc.

It finds the latest Python releases, sorts them by
various factors (arch, platform, flavor) and generates download
links to be included into openrye at build time.
"""
...
def render(downloads: list[PythonDownload]):
    ...
    print("// Generated by openrye-devtools. DO NOT EDIT.")
    print(
